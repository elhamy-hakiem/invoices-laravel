<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='dashboard') }}"><img src="{{URL::asset('assets/img/brand/loggo.png')}}" class="main-logo" alt="logo"></a>
				<a class="desktop-logo logo-dark active" href="{{ url('/' . $page='dashboard') }}"><img src="{{URL::asset('assets/img/brand/loggo-white.png')}}" class="main-logo dark-theme" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . $page='dashboard') }}"><img src="{{URL::asset('assets/img/brand/loggo.png')}}" class="logo-icon" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . $page='dashboard') }}"><img src="{{URL::asset('assets/img/brand/loggo.png')}}" class="logo-icon dark-theme" alt="logo"></a>
			</div>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoicesArchived') }}">الفواتير المؤرشفة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='invoices/status/'.$paid = 1) }}">الفواتير المدفوعة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='invoices/status/'.$paid = 0) }}">الفواتير الغير مدفوعة</a></li>
						</ul>
					</li>
                    {{-- End invoices setting  --}}

                    {{-- Start Reports Setting  --}}
