...
@section('content')
                ...
                @endif
                {{-- End   alert   message Add Success --}}

                {{-- start alert message Update Success   --}}
                @if (session()->has('edit'))
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                ...
                @endif
                {{-- End   alert   message Update Success --}}
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12 col-xl-12">
                                                <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">اضافة منتج <i class=" fa fa-plus"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
{{-- End Put Edite Data In form --}}

{{-- Start Put Delete Data In form --}}
<script>
